...
# ╔═╡ 23212ea4-0995-4cc2-a5be-13607af18477
...
# ╔═╡ f8de9851-d09c-4858-8d55-283555b417bd
begin
...
# ╔═╡ 7522d366-361a-408b-98c3-487323d44642
begin
...
# ╔═╡ 488969d7-43eb-4479-89e6-1d7f43a0fa2b
begin	
	# This block defines the simulation parameters for slow and fast Ω values. It also runs the solver for both scenarios.
	
	initial_state = [30*pi/180, 0.0]   # 30-deg initial displacement
	parameters_slow = (9.81, 0.15, 0.1, 0.1, 0.2) # g, L, Ω, w1, h1
	parameters_fast = (9.81, 0.15, 10, 0.1, 0.2)
	time_span     = (0.0, 3.0)
	...
	sol_slow = solve(prob_slow, reltol = 0.000001)
	sol_fast = solve(prob_fast, reltol = 0.000001)
end

# ╔═╡ ae7d58c8-b9e5-4092-82d1-e5bc52e77024
# Animation with three panels: θ(t), ω(t), and pendulum motion
# Packages referenced: Plots.jl, DifferentialEquations.jl
# x and y data is offset to be displayed in x' and z' coordinates
...
function animate_pendulum(sol, parameters; number_frames=150, filename="pendulum.gif")
    ...
    anim = @animate for time_value in time_values
        ...
        bob_y = -length_pendulum * cos(angle_current) + 0.2

        pendulum_plot = plot(
            xlim=(w1 - 1.2length_pendulum, w1 + 1.2length_pendulum),
            ylim=(h1 - 1.2length_pendulum, h1 + 0.2length_pendulum),
            aspect_ratio=:equal,
...
manifest_format = "2.0"
project_hash = "8084a7926660b76af11e511892dce24f814e4878"
